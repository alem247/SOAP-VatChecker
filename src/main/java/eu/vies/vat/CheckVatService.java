 ...
 * 
 */
@WebServiceClient(name = "checkVatService", targetNamespace = "urn:ec.europa.eu:taxud:vies:services:checkVat", wsdlLocation = "http://ec.europa.eu/taxation_customs/vies/services/checkVatService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://ec.europa.eu/taxation_customs/vies/services/checkVatService.wsdl");
